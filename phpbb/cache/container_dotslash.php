...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['controller.helper'] = new \phpbb\controller\helper($this->get('template'), $this->get('user'), $this->get('config'), $this->get('controller.provider'), $this->get('ext.manager'), $this->get('symfony_request'), $this->get('filesystem'), './', 'php');
    }
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('localhost', 'hellsapphire', 'asd', 'forumtest', '', false, false);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dbal.dbuser' => 'hellsapphire',
            'dbal.dbpasswd' => 'asd',
            'dbal.dbname' => 'forumtest',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
